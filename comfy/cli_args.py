...
parser.add_argument("--vae-kl-mem-ratio", type=float, default=None, metavar="RATIO", help="Override the VAE memory estimation ratio used in AutoencoderKL (affects memory_used_encode/decode calculations). Default is 1.3 for AMD/ROCm (matching modern ROCm VAE fixes) or 1.0 otherwise. Override higher (e.g. --vae-kl-mem-ratio 2.73) if you hit VAE corruption; lower for tighter VRAM. Ideal for benchmarking.")
